...
2. Clone the repo:
   ...
   ```bash
   git clone https://github.com/MonkTeam/aria-telegram-mirror-bot
...
12. Open Telegram, and send `/mirror https://raw.githubusercontent.com/MonkTeam/aria-telegram-mirror-bot/master/README.md` to the bot.
